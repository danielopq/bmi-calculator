...
function getReport(mSystem) {
	...
	var idealWeight = "Your ideal weight is between: <br>";
...
/**
*<p>Search the minimun and the maximun recommended weight according to the user height</p>
*@param mSystem measuring system selected (metric or imperial)
*@param userHeight height given by the user
*@return idealWeight minimun and maximun recommended weight
*/
function getIdealWeight(mSystem,userHeight){
	...
	if(mSystem == "metric"){
		...
		for(var z = 0;z<imperial.length;z++){
